...
# CIE L*a*b*    - L (lightness), a (green-red components), b (blue-yellow components)
# HSL           - hue, saturation, lightness
# HSV           - hue, saturation, value
# YCbCr         - used in video and digital photography, Y (chroma), Cb & Cr (chrominance components)

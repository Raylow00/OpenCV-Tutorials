...
ret2, thresh2 = cv2.threshold(gray_image_filtered, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
...
show_img_with_matplotlib(cv2.cvtColor(thresh2, cv2.COLOR_GRAY2BGR), "Otsu's binarization after filter", 6)
